...
char *const args[2][10] = {{"shared/lab_10_02_02/app.exe", "app.exe", NULL},
                           {"shared/lab_09_01_03/app.exe", "app.exe",
                            "shared/lab_09_01_03/shared/file.txt", "500", NULL}};
